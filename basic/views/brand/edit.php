...
<div class="main-div">
    <form method="post" action="/brand/edit"enctype="multipart/form-data" >
        <input type="hidden" name="id" class="id" value="<?php echo $BrandRow['id']; ?>"/>
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">品牌名称</td>
                <td>
                    <input type="text" name="name" class="name" maxlength="60" value="<?php echo $BrandRow['name']; ?>" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <div class="upload-img-box" style="display: <?php if(empty($BrandRow['logo'])){echo 'none';}else{} ?>">
                        <div class="upload-pre-item">
                            <img src="<?php echo $BrandRow['logo']; ?>" alt=""/>
                            <input type="hidden" name="logo" value="<?php echo $BrandRow['logo']; ?>"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="sort" class="sort" maxlength="40" size="15" value="<?php echo $BrandRow['name']; ?>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea  name="intro" class="intro" cols="60" rows="4"  ><?php echo $BrandRow['name']; ?></textarea>
                </td>
            </tr>
            <tr>
...
<script>
    $(function(){
        $(":radio[name='status']").val([<?php if(!empty($BrandRow['status'])){echo $BrandRow['status'];}else{echo 1;} ?>]);
        /**图片上传**/
