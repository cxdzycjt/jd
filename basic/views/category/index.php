...
<form method="post" action="" name="listForm">
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="tree">
            ...
            ?>
                    <tr class="treegrid-<?php echo $category['id']; ?> <?php if($category['parent_id']!=1){echo "treegrid-parent-".$category['parent_id'];}else{echo '';} ?> ">
                        <td class="first-cell"><?php echo $category['name']; ?></td>
                        <td class="first-cell" align="center"><?php echo $category['parent_id']; ?></td>
                        ...
                        <td align="center" width="15%"><?php echo date('Y-m-d H:i:s',$category['createTime']); ?></td>
